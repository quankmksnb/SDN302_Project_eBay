                ...
                >
                    ...
                    <div className="max-h-[360px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                        {notifications.map((noti) => (
                            <div
                                key={noti.id}
                                className={`flex gap-3 items-start p-3 hover:bg-gray-50 cursor-pointer transition ${noti.unread ? "bg-blue-50" : ""
                                    }`}
                            >
                                <Image
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-gray-400 mt-1">{noti.time}</div>
                                </div>
                            </div>
                        ))}
                    </div>
